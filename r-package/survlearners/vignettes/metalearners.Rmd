...
Based on $\widehat{S^C}(\cdot)$, we then re-weight every subject  $i \in \mathcal{I}_{\text{comp}}$ by $\hat{K}_i$, an estimate of the inverse of the probability of not being censored, namely:
