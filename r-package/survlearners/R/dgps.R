# dgps.R - Data generating processes for Metalearners-Benchmark
...
#' @param p_b The number of covariates in the main effect function.
#' @param p_i The number of covariates in the interaction term.
#' @param f_b Function form of the main effects (linear/nonlinear).
#' @param f_i Function form of the interaction term (linear/nonlinear).
#' @param times The time of interest.
#' @param pi The probability of receiving treatment.
#' @param beta The coefficient of main effect.
#' @param gamma The coefficient of treatment-covariate interaction.
#' @param rho The shape parameter of a Weibull distribution for censoring time.
#' @param cen_scale The scale parameter of a Weibull distribution for censoring time.
#' @param cenM The complexity of censoring mechanism (independent/dependent of covariates).
...
#'  `catesp`: the treatment effect estimated by monte carlo, `catesp.sign`: the true sign of the cate for ITR comparison,
